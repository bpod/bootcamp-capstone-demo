...
Generate comprehensive documentation for React component ${selection} or ${file}.

**Your Task**: Analyze component (props, types, behavior), generate JSDoc/TSDoc comments + README section with props table, usage examples, accessibility notes, TypeScript interfaces.

**Documentation Structure**:

1. **Component Name & Purpose**: One-sentence description of what component does and when to use it
2. **Props Table**: Name, Type, Required/Optional, Default, Description for each prop
3. **Basic Example**: Simple usage showing required props
4. **Advanced Examples**: Variants, edge cases, composition patterns
5. **Accessibility**: ARIA attributes used, keyboard navigation support, screen reader considerations
6. **TypeScript**: Exported interfaces/types for props, events, slots
7. **Notes**: Known limitations, browser support, performance considerations

**Format**: Follow Storybook/Docusaurus conventions. Generate both inline JSDoc comments and standalone markdown.
...
| ------- | ------------------------ | -------- | --------- | ------------------- |
| variant | 'primary' \| 'secondary' | No       | 'primary' | Button visual style |
...
**Success Criteria**: Complete props documentation, runnable examples, accessibility guidance clear, TypeScript types exported.
